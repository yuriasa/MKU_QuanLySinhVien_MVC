                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="gioitinh" name="gioitinh" required>
                                    ...
                                    <option value="1" <?= (isset($sinhvien[0]->GioiTinh) && $sinhvien[0]->GioiTinh == 1) ? 'selected' : '' ?>>Nam</option>
                                    <option value="0" <?= (isset($sinhvien[0]->GioiTinh) && $sinhvien[0]->GioiTinh == 0) ? 'selected' : '' ?>>Nữ</option>
                                </select>
                            </div>
